...
export default function ChildrenAttendanceInteraction() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center"><QrCode className="me-2 h-6 w-6 text-primary" /> تسجيل الحضور والمكافآت</CardTitle>
