...
import { Users, Child, Link as LinkIcon, Eye, Plus, Calendar, Award, Activity, AlertCircle, TrendingUp } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/components/ui/dialog';
import { PointsDisplay } from '@/components/shared/points-display';
import { AttendanceTracker } from '@/components/shared/attendance-tracker';
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <p className="text-blue-100">
            دليلتك لمتابعة أطفالك ومراقبة أنشطتهم
          </p>
        </motion.div>
          ...
          >
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-blue-100">أبن مرتبطين</div>
              </CardContent>
            </Card>
          </motion.div>
          <motion.div
        ...
        <Card>
          <CardHeader>
            <CardTitle>الأبنائي ({children.length})</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
                      ...
                      <CardHeader className="pb-3">
                        ...
                        <CardContent className="space-y-3">
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            <span>{child.createdAt ? new Date(child.createdAt).toLocaleDateString('ar-EG') : 'غير معروف'}
                          </span>
                          </div>
                          <div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="text font-medium">تاريخ الميلاد</label>
                        <span className="text-lg font-semibold">
